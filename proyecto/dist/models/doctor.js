...
], Doctor.prototype, "id_prof", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
...
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.ENUM('medicina_general', 'cardiologia', 'medicina_interna', 'dermatologia', 'rehabilitacion_fisica', 'psicologia', 'odontologia', 'radiologia'),
        allowNull: false
    }),
    __metadata("design:type", String)
], Doctor.prototype, "especialidad", void 0);
__decorate([
    (0, sequelize_typescript_1.HasMany)(() => cita_1.Cita),
